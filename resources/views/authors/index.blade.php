                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse ($authors as $author)
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium  {{ $author->status == 'active' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">{{ $author->status }}</span>
                                </td>
                                <td class="px-6 py-4">
