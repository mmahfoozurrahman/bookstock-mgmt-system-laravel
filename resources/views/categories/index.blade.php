                ...
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="font-medium text-gray-800">Fiction</div>
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-600">Novels and stories</td>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="font-medium text-gray-800">Science</div>
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-600">Scientific books and journals</td>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="font-medium text-gray-800">History</div>
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-600">Historical books and documents</td>
